...
NOTE: This guide uses Helm and Kubectl for deploying the Hazelcast cluster. If you want to use the Hazelcast Platform Operator instead, you can see the guide https://guides.hazelcast.org/hazelcast-platform-operator-expose-externally/main/[here].
...
----
cd cpp-unisocket
cmake -S . -B build -DCMAKE_BUILD_TYPE=Release && cmake --build build --verbose
./build/cpp-unisocket
----
--
