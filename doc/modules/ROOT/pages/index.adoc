...
This is a complete example presenting how to use Hazelcast cluster deployed on Kubernetes with Hazelcast Client running outside of Kubernetes. This guide uses Helm and Kubectl for deploying the Hazelcast cluster. If you want to use the Hazelcast Platform Operator instead, you can see the guide https://guides.hazelcast.org/hazelcast-platform-operator-expose-externally/main/[here].
...
.values.yaml
----
include::../../../../service-per-pod/values.yaml[]
----
