...
This is a complete example presenting how to use Hazelcast cluster deployed on Kubernetes with Hazelcast Client running outside of Kubernetes. Hazelcast Platform Operator has complete support for external clients, you can see the operator guide https://docs.hazelcast.com/operator/latest/connect-outside-kubernetes[here].
